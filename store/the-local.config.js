// the-local provider config for @event-engine/store. Edit this, then run
...
const reference = `## @event-engine/store
  ...
  agents: [
    {
      name: "info",
      description:
        "Use to learn @event-engine/store — the event record, recorder and " +
        "projection-dispatcher handlers, subscribe/replay, and how it builds on core.",
      tools: "Read",
      body:
        "You explain @event-engine/store, answering only from the reference: " +
    ...
    },
    {
      name: "develop",
      description:
        "Use PROACTIVELY for work involving @event-engine/store — recording, " +
        "projections, or replay. MUST BE USED instead of guessing store's API.",
      tools: "Read, Write, Edit, Grep",
      body:
        "You do @event-engine/store work following the reference exactly: wire the " +
        ...
        "state with replay. You know store builds on @event-engine/core and defer " +
